...
class ContextBlock(nn.Module):
    ...
    def spatial_pool(self, x):
        ...
        if self.pooling_type == 'att':
            ...
            # [N, 1, C, 1]
            context = nn.matmul(input_x, context_mask)
            # [N, C, 1, 1]
...
class YOLOv3(nn.Cell):
    ...
    def __init__(self, feature_shape, backbone_shape, backbone, out_channel):
        ...
        self.context1 = ContextBlock(inplanes=64, ratio=0.2)
        self.context2 = ContextBlock(inplanes=64, ratio=0.2)
